...
_this forceAddUniform "BwS_T_ADJ";
...
_this addBackpack "BwS_Small_Medic";
for "_i" from 1 to 11 do {_this addItemToBackpack "ACE_epinephrine";};
for "_i" from 1 to 12 do {_this addItemToBackpack "ACE_morphine";};
